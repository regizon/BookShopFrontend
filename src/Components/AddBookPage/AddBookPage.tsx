        ...
        for(let attempts= 0; attempts <= maximum_attempts; attempts++){
            try{
                ...
                setAddBookForm({
                    ...
                    genres: genreVariations[bookInfo['categories']],
    ...
    return(
        <div className={styles.content}>
            ...
            <div className={styles.formWrapper}>
                ...
                <div className={styles.inputBlock}>
                    <div className={styles.leftBlock}>
                        ...
                        <input id={"author"} name={"author"} value={addBookForm.author} onChange={handleAddFormChange}/>
                        <label htmlFor={"genres"}>Жанр(и)</label>
                        <input id={"genres"} name={"genres"} value={addBookForm.genres} onChange={handleAddFormChange}/>
            ...
            <div className={styles.buttonContainer}>
                <button className={styles.saveButton}>Зберегти книгу</button>
            </div>
        </div>
    )
}
